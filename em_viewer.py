...
# Neuron IDs - keep consistent with generation script
NEURON_IDS = {
...
# Neuroscience colors with nuances
NEURON_COLORS = {
    # VS neurons - Teal (#1B9E77) with nuances
    'VS1_L': '#1B9E77', 'VS1_R': '#2DB387',
    'VS2_L': '#16856A', 'VS2_R': '#1FA67E',
    'VS3_L': '#148866', 'VS3_R': '#1C9575',
    'VS4_L': '#12725C', 'VS4_R': '#1A8A6F',
    'VS5_L': '#1B9E77', 'VS5_R': '#23AC84',
    'VS6_L': '#17916E', 'VS6_R': '#1F9F7B',
    'VS7_L': '#15826B', 'VS7_R': '#1D9373',
    'VS8_L': '#13785F', 'VS8_R': '#1B8A6D',
    
    # HS neurons - Orange (#D95F02) with nuances
    'HSN_L': '#D95F02', 'HSN_R': '#E57422',
    'HSE_L': '#C35502', 'HSE_R': '#D16912',
    'HSS_L': '#AD4B02', 'HSS_R': '#BB5912',
    
    # Motor neurons - Purple (#7570B3) with nuances
    'MOT_L': '#7570B3', 'MOT_R': '#8A85C3',
    'MOS_L': '#6660A3', 'MOS_R': '#7B75B8',
}
